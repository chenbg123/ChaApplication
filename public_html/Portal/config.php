...
@session_start();
//API host link
$baseurl = "http://localhost/public_html/API/index.php?p=";
$firebaseDb_URL="https://chat-7c6db-default-rtdb.firebaseio.com/";
	...
	if( $_GET['login'] == "ok" ) { //login user
	    ...
	    if( !empty($email) && !empty($password) ) { 
			...
			{	
				...
				echo "<script>window.location='dashboard.php?p=chat_bot'</script>";
