...
<head>
	...
	<link rel="shortcut icon" href="img/logo.png?time=<?php echo time(); ?>">	
				...
				<div class="wdth">
					<div class="logo left">
						<a href="index.php" style="text-decoration: none !important;">
						    ...
						    <h1 style="background: -webkit-linear-gradient(#8E54E9, #4776E6); -webkit-background-clip: text; -webkit-text-fill-color: transparent;position: relative; margin:-37px 0 0 45px;font-size: 32px; ">Chatbot Management System</h1>
						</a>
					</div>
